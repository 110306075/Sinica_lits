...
def train_and_eval_all_folds(n_folds=N_FOLDS,case = 'liver_seg',filter_tumor_size_path=None,img_dir='train_images',mask_dir='train_masks',filter_out=None):
    df = build_metadata(n_folds=n_folds,filter_tumor_size_path=filter_tumor_size_path,img_dir=img_dir,mask_dir=mask_dir,filter_out=filter_out)
    results = []
...
def dataset_purify(n_folds=N_FOLDS,case = 'liver_seg',filter_tumor_size_path=None,img_dir='train_images',mask_dir='train_masks',filter_out=None):
    df = build_metadata(n_folds=n_folds,filter_tumor_size_path=filter_tumor_size_path,img_dir=img_dir,mask_dir=mask_dir,filter_out=filter_out)
    results = []
...
if __name__ == '__main__':
    result_df = train_and_eval_all_folds(case='large_tumor_and_liver'
